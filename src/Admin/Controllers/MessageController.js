...
const CoursesUpdateImg = require("./Courses/CoursesUpdateVideo");
  ...
  try {
    ...
    if (text == "/start" && admin.step == 0) {
      ...
      if (text == "⬅️ Ortga") {
        ...
        await CoursesUpdateImg(bot, message, admin, productId);
      } else if (step == "video") {
